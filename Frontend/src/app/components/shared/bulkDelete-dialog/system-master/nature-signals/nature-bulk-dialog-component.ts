...
@Component({
  selector: 'app-nature-bulk-dialog',
  standalone: true,
    ...
    <div class="table-responsive">
      <table mat-table [dataSource]="data" class="table-hover mat-elevation-z8">
        ...
        <ng-container matColumnDef="name">
          ...
          <td mat-cell *matCellDef="let tag"> {{tag.natureOfSignalName}}</td>
        </ng-container>
...
export class NatureBulkDialogComponent {

  displayedColumns: string[] = ['name'];

  constructor(
    public dialogRef: MatDialogRef<NatureBulkDialogComponent>,
