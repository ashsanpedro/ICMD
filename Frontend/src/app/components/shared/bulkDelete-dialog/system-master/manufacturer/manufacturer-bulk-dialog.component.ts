...
@Component({
  selector: 'app-manufacturer-bulk-dialog',
  standalone: true,
    ...
    <div class="table-responsive">
      <table mat-table [dataSource]="data" class="table-hover mat-elevation-z8">
        ...
        <ng-container matColumnDef="comment">
          ...
          <td mat-cell *matCellDef="let tag"> {{tag.comment}}</td>
        </ng-container>
...
export class ManufacturerBulkDialogComponent {

  displayedColumns: string[] = ['name', 'description', 'comment'];

  constructor(
    public dialogRef: MatDialogRef<ManufacturerBulkDialogComponent>,
