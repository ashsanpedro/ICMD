...
@Component({
  ...
  <div mat-dialog-content>
    <p class="text-center fs-5">Are you sure you want to delete the following Sub-System?</p>
    ...
    <div class="table-responsive">
      <table mat-table [dataSource]="data" class="table-hover mat-elevation-z8">
        ...
        <ng-container matColumnDef="wap">
          <th mat-header-cell *matHeaderCellDef> Work Area Pack </th>
          <td mat-cell *matCellDef="let system"> {{system.workAreaPack}}</td>
        </ng-container>

        <!-- System Column -->
        <ng-container matColumnDef="system">
          <th mat-header-cell *matHeaderCellDef> System </th>
          <td mat-cell *matCellDef="let system"> {{system.system}}</td>
        </ng-container>

        <!-- Number Column -->
        <ng-container matColumnDef="number">
          <th mat-header-cell *matHeaderCellDef> Number </th>
          <td mat-cell *matCellDef="let system"> {{system.number}}</td>
        </ng-container>

        <!-- Description Column -->
        <ng-container matColumnDef="description">
          <th mat-header-cell *matHeaderCellDef> Description </th>
          <td mat-cell *matCellDef="let system"> {{system.description}}</td>
        </ng-container>
...
export class SubBulkDialogComponent {

  displayedColumns: string[] = ['wap', 'system', 'number', 'description'];

  constructor(
    public dialogRef: MatDialogRef<SubBulkDialogComponent>,
