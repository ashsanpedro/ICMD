...
@Component({
  selector: 'app-TFRoom-bulk-dialog',
  standalone: true,
  ...
  <div mat-dialog-content>
    <p class="text-center fs-5">Are you sure you want to delete the following Steam Name?</p>
    ...
    <div class="table-responsive">
      <table mat-table [dataSource]="data" class="table-hover mat-elevation-z8">
        ...
        <ng-container matColumnDef="name">
          ...
          <td mat-cell *matCellDef="let room"> {{room.streamName}}</td>
        </ng-container>
...
export class TFRoomBulkDialogComponent {

  displayedColumns: string[] = ['name', 'description'];

  constructor(
    public dialogRef: MatDialogRef<TFRoomBulkDialogComponent>,
