...
@Component({
  ...
  <div mat-dialog-content>
    <p class="text-center fs-5">Are you sure you want to delete the following work area packs?</p>
    ...
    <div class="table-responsive">
      <table mat-table [dataSource]="data" class="table-hover mat-elevation-z8">
        ...
        <ng-container matColumnDef="number">
          ...
          <td mat-cell *matCellDef="let pack"> {{pack.number}}</td>
        </ng-container>

        <!-- Description Column -->
        <ng-container matColumnDef="description">
          <th mat-header-cell *matHeaderCellDef> Description </th>
          <td mat-cell *matCellDef="let pack"> {{pack.description}}</td>
        </ng-container>
...
export class WapBulkDialogComponent {

  displayedColumns: string[] = ['number', 'description'];

  constructor(
    public dialogRef: MatDialogRef<WapBulkDialogComponent>,
