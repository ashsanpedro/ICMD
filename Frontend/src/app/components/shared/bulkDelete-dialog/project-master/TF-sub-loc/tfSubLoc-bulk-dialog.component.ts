...
@Component({
  selector: 'app-TFSubLoc-bulk-dialog',
  standalone: true,
  ...
  <div mat-dialog-content>
    ...
    <div class="table-responsive">
      <table mat-table [dataSource]="data" class="table-hover mat-elevation-z8">
        ...
        <!-- Sub - Process Name Column -->
        <ng-container matColumnDef="sub">
          <th mat-header-cell *matHeaderCellDef> Sub - Process Name </th>
          <td mat-cell *matCellDef="let sub"> {{sub.subProcessName}}</td>
        </ng-container>

        <!-- Description Column -->
        <ng-container matColumnDef="description">
          <th mat-header-cell *matHeaderCellDef> Description </th>
          <td mat-cell *matCellDef="let sub"> {{sub.description}}</td>
        </ng-container>
...
export class TFSubLocBulkDialogComponent {

  displayedColumns: string[] = ['sub', 'description'];

  constructor(
    public dialogRef: MatDialogRef<TFSubLocBulkDialogComponent>,
