...
@Component({
  selector: 'app-system-bulk-dialog',
  standalone: true,
  ...
  <div mat-dialog-content>
    <p class="text-center fs-5">Are you sure you want to delete the following System?</p>
...
export class SystemBulkDialogComponent {

  displayedColumns: string[] = ['number', 'description', 'wap'];

  constructor(
    public dialogRef: MatDialogRef<SystemBulkDialogComponent>,
