...
namespace ICMD.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20231211091043_SPGetDeviceTypeModelNatureOfSignalAttributeDefinitionIDs")]
    partial class SPGetDeviceTypeModelNatureOfSignalAttributeDefinitionIDs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ICMD.Core.Dtos.Instrument.ViewInstrumentListLiveDto", b =>
                {
                    ...
                    b.Property<double?>("CalibratedRangeMax")
                        .HasColumnType("double precision")
                        .HasColumnName("Calibrated Range (Max)");

                    b.Property<double?>("CalibratedRangeMin")
                        .HasColumnType("double precision")
                    ...
                    b.Property<double?>("ProcessRangeMax")
                        .HasColumnType("double precision")
                        .HasColumnName("Process Range (Max)");

                    b.Property<double?>("ProcessRangeMin")
                        .HasColumnType("double precision")
            ...
            modelBuilder.Entity("ICMD.Core.ViewDto.ViewDeviceInstrumentsDto", b =>
                {
                    ...
                    b.ToView("View_Device_Instruments", (string)null);
                });
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.Device", b =>
                {
                    ...
                    b.HasOne("ICMD.Core.DBModels.JunctionBox", "JunctionBoxTag")
                        .WithMany()
                    ...
                    b.HasOne("ICMD.Core.DBModels.Panel", "PanelTag")
                        .WithMany()
                    ...
                    b.HasOne("ICMD.Core.DBModels.Skid", "SkidTag")
                        .WithMany()
                        .HasForeignKey("SkidTagId");

                    b.HasOne("ICMD.Core.DBModels.Stand", "StandTag")
                        .WithMany()
