...
namespace ICMD.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20241105080824_UpdateView_NonInstrumentList")]
    partial class UpdateView_NonInstrumentList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.MenuItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.MenuPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.MetaData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.PermissionManagement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PermissionManagement");
                });
            ...
            modelBuilder.Entity("ICMD.Core.Dtos.ViewNatureOfSignalValidationFailuresDto", b =>
                {
                    b.Property<Guid?>("DeviceId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool?>("HistoricalLogging")
                        .HasColumnType("boolean")
                        .HasColumnName("Historical Logging");

                    b.Property<double?>("HistoricalLoggingFrequency")
                        .HasColumnType("double precision")
                        .HasColumnName("Historical Logging Frequency");

                    b.Property<double?>("HistoricalLoggingResolution")
                        .HasColumnType("double precision")
                        .HasColumnName("Historical Logging Resolution");
                    ...
                    b.ToView("View_NatureOfSignalValidationFailures", (string)null);
                });
            ...
            modelBuilder.Entity("ICMD.Core.ViewDto.ViewOMItemInstrumentListDto", b =>
                {
                    b.Property<string>("AFDHubNumber")
                        .HasColumnType("text")
                        .HasColumnName("AFD / Hub Number");
                    ...
                    b.ToView("View_OMItem_InstrumentList", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewPSSTagsDto", b =>
                {
                    b.Property<string>("CBTagNumber")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SignalExtension")
                        .HasColumnType("text");
                    ...
                    b.ToView("View_PSSTags", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewPnIDDeviceDocumentReferenceCompareDto", b =>
                {
                    b.Property<Guid>("DeviceId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PnIdDocumentNumber")
                        .HasColumnType("text");

                    b.Property<string>("PnIdRevision")
                        .HasColumnType("text");

                    b.Property<string>("PnIdVersion")
                        .HasColumnType("text");
                    ...
                    b.ToView("View_PnID_Device_DocumentReferenceCompare", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewPnIDTagExceptionDto", b =>
                {
                    b.Property<string>("EquipmentCode")
                        .HasColumnType("text");
                    ...
                    b.ToView("View_PnIDTagException", (string)null);
                });
            ...
            modelBuilder.Entity("ICMD.Core.ViewDto.ViewUnassociatedJunctionBoxesDto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToView("View_UnassociatedJunctionBoxes", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewUnassociatedPanelsDto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToView("View_UnassociatedPanels", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewUnassociatedSkidsDto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToView("View_UnassociatedSkids", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewUnassociatedStandsDto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToView("View_UnassociatedStands", (string)null);
                });

            modelBuilder.Entity("ICMD.Core.ViewDto.ViewUnassociatedTagsDto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToView("View_UnassociatedTags", (string)null);
                });
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.MenuItems", b =>
                {
                    b.HasOne("ICMD.Core.DBModels.MenuItems", "ParentMenu")
                        .WithMany()
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.MenuPermission", b =>
                {
                    b.HasOne("ICMD.Core.DBModels.MenuItems", "MenuItems")
                        .WithMany()
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ICMD.Core.Authorization.ICMDRole", "ICMDRole")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ICMDRole");
            ...
            modelBuilder.Entity("ICMD.Core.DBModels.PermissionManagement", b =>
                {
                    b.HasOne("ICMD.Core.DBModels.MenuPermission", "MenuPermission")
                        .WithMany()
