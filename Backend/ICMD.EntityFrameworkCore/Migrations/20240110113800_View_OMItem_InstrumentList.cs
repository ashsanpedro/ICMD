...
{
    /// <inheritdoc />
    public partial class View_OMItem_InstrumentList : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE OR REPLACE VIEW public.""View_OMItem_InstrumentList""
 AS
 SELECT ""OMItem"".""Id"",
    ""OMItem"".""ItemId"",
    ...
    ""View_InstrumentListLive"".""IsActive"",
    ""View_InstrumentListLive"".""IsDeleted"",
        CASE
